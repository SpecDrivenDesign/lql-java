package com.github.ryancopley.lql.main;

import com.github.ryancopley.lql.pkg.ast.expressions.*;
import com.github.ryancopley.lql.pkg.bytecode.Bytecode;
...
import com.github.ryancopley.lql.pkg.signing.Signing;
import com.github.ryancopley.lql.pkg.testing.Testing;
import com.github.ryancopley.lql.pkg.tokens.Tokens;
...
private static void runTestCmd(String[] args) throws Exception {
    ...
    private static void runExecCmd(String[] args) throws Exception {
        ...
        if (expr != null && !expr.isEmpty()) {
            ...
            Env env = Env.newEnvironment();
            Object result = ((com.github.ryancopley.lql.pkg.ast.Expression) ast).eval(ctx, env);
        ...
        Parser p = new Parser((com.github.ryancopley.lql.pkg.lexer.Lexer) tokenStream);
        Object ast = p.parseExpression();
        Env env = Env.newEnvironment();
        Object result = ((com.github.ryancopley.lql.pkg.ast.Expression) ast).eval(ctx, env);
        System.out.println("Execution result: " + result);
